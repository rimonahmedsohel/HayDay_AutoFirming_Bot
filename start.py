...
def run_master_loop():
    ...
    while is_running:
        ...
        print("\n========================================")
        print(f"         SELLING TEST CYCLE #{cycle_count}")
        print("========================================")
        
        # ---------------------------------------------------------
        # PHASE 3: SELLING (Isolated test mode)
        # ---------------------------------------------------------
        print("\n--- PHASE 3: SELLING ---")
        ...
        if sell_bot.get_adb_screenshot():
            ...
            if did_sell:
                print("Selling phase triggered.")
            else:
                print("Selling phase conditions not met.")
        else:
             print("Failed to capture screenshot for Selling.")
             
        if not is_running: break
        
        if False: # TEMPORARILY DISABLED FOR SELLING TEST
        ...
        # A small delay so the bot doesn't spam the CPU 1000 times a second if nothing is found.
        time.sleep(3.0)
