...
class SimpleHayDayBot:
    ...
    def exact_planting_sequence(self):
        ...
        print("--> Planting batch complete! Repeating for remaining empty fields...\n")
        time.sleep(1.0)
        return True
